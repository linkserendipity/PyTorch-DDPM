...
parser.add_argument('--dir', type=str, default='/media/SSD/lingsen/data/CK+/class/', help="data dir")
...
plt.savefig("output/{}_{}_{}_{}_{}_output.png".format(class_1, image_size, batch_size, epochs, timesteps))
plt.close(fig)
...
plt.savefig("output/{}_{}_{}_{}_{}_reverse.png".format(class_1, image_size, batch_size, epochs, timesteps))
plt.close(fig1)
