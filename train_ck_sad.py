...
dataset = ImageFolder('/mnt/SSD/ls/CK+/sad/', transform = transform) #!！!!！！!！!！!!！!！!！!！!！!！!! @
...
for epoch in range(epochs):
    for step, (images, labels) in enumerate(train_loader):
        ...
        batch_size = images.shape[0] #@ images.shape = torch.Size([64, 1, 28, 28]) to [16, 1, 128, 128]
...
plt.savefig("64_200_5000_output_sad.png")
plt.close(fig)
...
plt.savefig("64_200_5000_reverse_sad.png")
plt.close(fig1)
